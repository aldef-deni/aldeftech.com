...
return [
  'custom' => [
    ...
    'primaryColor' => '#8A6C3C', // Antique champagne — brand accent with AA-safe white text
    ...
    'hasCustomizer' => false, // Locked: the console ships with the Aldef Tech skin
    'displayCustomizer' => false, // Locked: the console ships with the Aldef Tech skin
