...
<div class="max-w-2xl">
    <form method="POST" action="{{ route('admin.settings.whatsapp.update') }}">
        @csrf @method('PUT')
        <x-admin.form.input label="WhatsApp Number" name="whatsapp_number" :value="\App\Models\SiteSetting::get('whatsapp_number', config('aldeftech.whatsapp.number'))" placeholder="628128968609" help="Include country code, no + or spaces" />
