...
<a href="{{ \App\Services\WhatsAppService::getUrl() }}" target="_blank" rel="noopener"
   ...
   title="Chat via WhatsApp">
    ...
    <span class="absolute -top-10 right-0 bg-white text-gray-800 text-xs px-3 py-1.5 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
        Chat via WhatsApp
    </span>
</a>
@endif
