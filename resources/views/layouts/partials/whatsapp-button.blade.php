    ...
    <div x-show="open" x-cloak
        ...
        <div class="p-4 space-y-2.5">
            ...
            <a href="{{ $waUrl }}" target="_blank" rel="noopener" class="card-quiet flex items-center gap-3 p-3 group"
               data-analytics-event="whatsapp_click" data-analytics-cta-location="floating_whatsapp"
            ...
            <a href="{{ lroute('contact') }}" class="card-quiet flex items-center gap-3 p-3 group">
                <span class="icon-plate icon-plate-sm">
