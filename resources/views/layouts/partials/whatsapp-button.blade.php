...
<div class="wa-widget" x-data="{ open: false }">
    ...
    <div x-show="open" x-cloak
        ...
        <div class="flex items-center justify-between pb-3.5 border-b border-slate-100">
            ...
            <button @click="open = false" class="text-slate-400 hover:text-slate-600 p-1 rounded-lg hover:bg-slate-100 transition-colors" aria-label="Close popup">
    ...
    {{-- Main Float Button --}}
    <button @click="open = !open" type="button" class="wa-float-btn relative" aria-label="WhatsApp Consultation">
