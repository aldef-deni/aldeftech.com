...
<section class="home-pillars-dark section-padding relative overflow-hidden">
    ...
    <div class="shell relative z-10">
        ...
        {{-- Commissioner profile: same section, mirrored. Mobile stays photo
             ...
             portrait right. The .leadership-mirror rules below enforce that
             order in CSS, so it cannot be undone by a stale build or by a
        ...
        <div class="home-leadership-divider mt-20 lg:mt-28 pt-14 lg:pt-20 border-t border-white/10">
            <div class="leadership-mirror grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
