...
<section class="section-padding pt-20 relative">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <h1 class="text-display-sm font-display text-text-primary mb-7 reveal reveal-delay-1">{{ \App\Models\SiteSetting::get('about_title', 'About Aldef Tech') }}</h1>
            <p class="text-text-secondary text-body-lg leading-relaxed reveal reveal-delay-2">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="premium-card p-8 lg:p-10 reveal">
                <div class="section-eyebrow mb-5">Our Mission</div>
                <p class="text-text-secondary leading-relaxed text-body-lg">{{ \App\Models\SiteSetting::get('about_mission', 'Membantu bisnis membangun sistem digital yang efektif, scalable, dan sesuai dengan kebutuhan operasional mereka.') }}</p>
            </div>
            <div class="premium-card p-8 lg:p-10 reveal reveal-delay-1">
                <div class="section-eyebrow mb-5">Our Vision</div>
                <p class="text-text-secondary leading-relaxed text-body-lg">{{ \App\Models\SiteSetting::get('about_vision', 'Menjadi technology partner terpercaya yang membantu transformasi digital bisnis Indonesia melalui solusi software berkualitas tinggi.') }}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div class="reveal">
                ...
                <h2 class="text-heading font-display text-text-primary mb-2">{{ $ceoProfile->name }}</h2>
                <p class="text-accent font-display font-semibold mb-6">{{ $ceoProfile->position }}</p>
                <div class="text-text-secondary leading-relaxed whitespace-pre-line mb-8">{{ $ceoProfile->full_bio ?? $ceoProfile->short_bio }}</div>
            ...
            <div class="reveal-right reveal-delay-2">
                ...
                @else
                <div class="aspect-[4/3] bg-brand-surface-2 border border-brand-border rounded-2xl flex items-center justify-center max-w-md mx-auto relative">
                    <div class="absolute -inset-4 rounded-3xl border border-accent/10 -z-10"></div>
                    <div class="w-28 h-28 rounded-full bg-gradient-to-br from-accent/15 to-accent/5 border border-accent/20 flex items-center justify-center text-accent text-4xl font-display font-bold">{{ substr($ceoProfile->name, 0, 1) }}</div>
                </div>
                @endif
            </div>
        </div>
...
<section class="section-padding relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-5 sm:px-8 lg:px-10 text-center relative z-10">
        <h2 class="text-heading font-display text-text-primary mb-4 reveal">Siap Memulai Project?</h2>
        <p class="text-text-muted mb-8 reveal reveal-delay-1">Mari diskusikan bagaimana kami dapat membantu bisnis Anda.</p>
