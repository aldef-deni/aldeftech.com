...
@php
    ...
    $pageTitle = 'Kontak — Mulai Proyek Bersama Aldef Tech';
    $metaDescription = 'Hubungi Aldef Tech untuk konsultasi pembuatan sistem, aplikasi web, platform SaaS, dan automasi AI. Konsultasi awal tanpa biaya.';
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div class="lg:col-span-7">
                <div class="card-lux p-7 sm:p-9 lg:p-10 reveal">
                    ...
                    <p class="eyebrow">Brief Proyek</p>
                    <h2 class="mt-4 text-2xl lg:text-[1.75rem]">Ceritakan kebutuhan Anda</h2>
                    <p class="mt-3 text-sm leading-relaxed text-graphite-600">
                        Semakin konkret persoalannya, semakin akurat estimasi yang bisa kami berikan.
                    </p>
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-5" novalidate>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="company" name="company" value="{{ old('company') }}"
                                       autocomplete="organization" placeholder="Nama perusahaan"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="tel" id="whatsapp" name="whatsapp" value="{{ old('whatsapp') }}"
                                       autocomplete="tel" placeholder="08xx xxxx xxxx"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label for="budget_range" class="form-label">Perkiraan Anggaran</label>
                        ...
                        <div>
                            <label for="message" class="form-label">Ceritakan kebutuhannya <span class="required">*</span></label>
                            <textarea id="message" name="message" rows="6" required
                                      placeholder="Proses apa yang paling merepotkan saat ini? Berapa orang yang terlibat? Sistem apa yang sudah dipakai?"
                        ...
                        <div class="pt-2 flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <p class="text-xs text-graphite-400 text-center sm:text-left leading-relaxed">
                                Data Anda hanya dipakai untuk menanggapi permintaan ini.
                            </p>
                        </div>
                    </form>
                </div>
                ...
                <div class="lg:sticky lg:top-28 space-y-5" data-reveal-group="90">
                    ...
                    <a href="{{ WhatsAppService::getUrl() }}" target="_blank" rel="noopener"
                       class="card-lux card-lux-featured reveal group p-7 !flex-row items-start gap-5">
                        ...
                        <span class="min-w-0">
                            <span class="block font-display text-base font-semibold text-graphite-900">WhatsApp</span>
                            <span class="block text-sm text-graphite-600 mt-1 tabular">{{ $waNumber }}</span>
                            <span class="block text-xs text-gold-700 mt-2.5 font-medium">Jalur tercepat — biasanya dibalas &lt; 2 jam</span>
                        </span>
                    </a>
                    ...
                    <a href="mailto:{{ $email }}" class="card-lux reveal group p-7 !flex-row items-start gap-5">
                        ...
                        <span class="min-w-0">
                            <span class="block font-display text-base font-semibold text-graphite-900">Email</span>
                            <span class="block text-sm text-graphite-600 mt-1 break-all">{{ $email }}</span>
                            <span class="block text-xs text-graphite-400 mt-2.5">Untuk dokumen, RFP, dan lampiran</span>
                        </span>
                    </a>
                    ...
                    <a href="{{ $mapsUrl }}" target="_blank" rel="noopener" class="card-lux reveal group p-7 !flex-row items-start gap-5">
                        ...
                        <span class="min-w-0">
                            <span class="block font-display text-base font-semibold text-graphite-900">Lokasi</span>
                            <span class="block text-sm text-graphite-600 mt-1 leading-relaxed">{{ $address }}</span>
                            <span class="block text-xs text-gold-700 mt-2.5 font-medium">Buka di Google Maps →</span>
                        </span>
                    </a>

                    <div class="card-quiet reveal p-7">
                        <p class="eyebrow mb-5">Yang Terjadi Setelah Ini</p>
                        <ol class="space-y-4">
                            @foreach([
